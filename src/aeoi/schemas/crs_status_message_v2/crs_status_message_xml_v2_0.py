...
from aeoi.schemas.crs_status_message_v2.isocsmtypes_v1_1 import (
    CountryCodeType,
    LanguageCodeType,
)
...
class CrsMessageTypeIndicEnumType(Enum):
    """
    The MessageTypeIndic is currently not used for CRS Status message (for
    future use).
    """

    CRSMESSAGE_STATUS = "CRSMessageStatus"
...
class MessageSpecType:
    ...
    Attributes:
        ...
        message_ref_id: Unique identifier for this CRS Status message
        message_type_indic: Not used for CRS Status message
        corr_message_ref_id: Not used for CRS Status message
        reporting_period: Not used for CRS Status message
        timestamp:
    """
    ...
    message_type_indic: None | CrsMessageTypeIndicEnumType = field(
        default=None,
        metadata={
...
class OriginalMessageType:
    """
    Attributes:
        original_message_ref_id: The MessageRefID of the original CRS
...
@dataclass(kw_only=True)
class CrsMessageStatusType:
    class Meta:
        name = "CrsMessageStatus_Type"
...
@dataclass(kw_only=True)
class CrsstatusMessageOecd:
    """
    Attributes:
        message_spec:
        crs_status_message:
        version: CRS Status Message Version
    """

    class Meta:
        name = "CRSStatusMessage_OECD"
        namespace = "urn:oecd:ties:csm:v2"
    ...
    crs_status_message: CrsMessageStatusType = field(
        metadata={
            "name": "CrsStatusMessage",
            "type": "Element",
        }
    )
    version: str = field(
