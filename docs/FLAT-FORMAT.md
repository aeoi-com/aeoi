...
| `uid` | yes | text | UID of the reporting FI (IN), e.g. CHE-123.456.789 |
| `name` | yes | text | Legal name of the reporting FI |
| `contact` |  | text | Contact for queries (MessageSpec.Contact), optional |
...
| `doc_ref_id` |  | text | Leave empty: generated (CH<year>CH<uuid>). Fill only to reuse a known DocRefId |
...
| `org_name` |  | text | Organisation: legal name |
| `org_name_type` |  | text | Organisation: OECD202-208 Codes: OECD202, OECD203, OECD204, OECD205, OECD206, OECD207, OECD208. |
| `acct_holder_type` |  | text | Organisation: CRS101 passive NFE with CPs / CRS102 reportable person / CRS103 passive NFE reportable Codes: CRS101, CRS102, CRS103. |
