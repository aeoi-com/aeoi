...
const I18N = {
  de: {
    ...
    verdict_bad: "Das Portal würde diese Datei ablehnen",
    ...
    ov_note: "Anzahl Konten je Ansässigkeitsstaat des Kontoinhabers; ein Konto kann in mehreren Staaten zählen.",
    ov_none: "Keine Kontodaten lesbar.",
    kv_fi: "Meldendes Institut", kv_id: "ESTV-ID", kv_year: "Berichtsjahr", kv_type: "Meldungstyp", kv_balances: "Salden (Summe)", kv_flags: "Besonderheiten",
    type_CRS701: "Neumeldung (CRS701)", type_CRS702: "Korrekturmeldung (CRS702)", type_CRS703: "Nullmeldung (CRS703)",
    flag_closed: "{n} geschlossen", flag_undocumented: "{n} nicht dokumentiert", flag_dormant: "{n} ruhend", flag_joint: "{n} Gemeinschaftskonten", flag_none: "keine",
